...
const PAGE_CONTENT = {
  en: {
    ...
    programs: {
      ...
      prog3Desc: "Supporting small-scale tomato, vegetable, and fodder crop demonstration farming through basic training.",
  ...
  ar: {
    ...
    programs: {
      ...
      prog3Desc: "دعم زراعة الطماطم والخضروات ومحاصيل العلف بنماذج إرشادية صغيرة من خلال التدريب والمدخلات الأساسية.",
