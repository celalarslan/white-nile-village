...
const PAGE_CONTENT = {
  en: {
    ...
    programs: {
      ...
      prog3Desc: "Testing tomato, vegetables, fodder and grapes through small demonstration plots based on suitability analysis.",
      prog3Tag: "Food Security",
      prog4Title: "Livestock Support",
      prog4Desc: "Improving livestock husbandry through basic animal health awareness, feed planning, and a small shared dairy unit.",
  ...
  ar: {
    ...
    programs: {
      ...
      prog3Desc: "اختبار الطماطم والخضروات والأعلاف والعنب في مساحات تجريبية صغيرة وفقاً لفحص الملاءمة الميدانية.",
      prog3Tag: "الأمن الغذائي",
      prog4Title: "دعم الثروة الحيوانية",
      prog4Desc: "تحسين تربية الماشية من خلال التوعية بصحة الحيوان، تخطيط الأعلاف، وتأسيس وحدة ألبان صغيرة مشتركة.",
